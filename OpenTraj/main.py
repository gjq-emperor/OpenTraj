    ...
    for num_entry, entry in enumerate(config):
        ...
        for repeat_i in range(num_repeat):
            ...
            if 'pretrain' in entry:
                ...
                pretrainer_comm_param = {"dataloader": pretrain_dataloader, "meta_name": pretrain_data_name,
                ...
                for down_i, down_entry in enumerate(entry['downstream']):
                    ...
                    if down_task == 'search':
                        ...
                        trip_dataloader = DataLoader(DatasetClass(*search_metas, **dataset_config),
                                                     collate_fn=partial(DatasetClass.collate_fn,
                                                                        **dataloader_collate_fn_config) if hasattr(
                                                         DatasetClass, 'collate_fn') else None,
                                                     **dataloader_config)
